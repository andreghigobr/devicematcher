...
class UserAgentDeviceRegexParserTest {
    ...
    @ParameterizedTest
    @CsvSource({
        "'INVALID_INPUT_Mozillaxxxxxxxxxxxxxxxxfari/53df', 'unknown', '0.0.0', 'unknown', '0.0.0'",
        "'Mozilla/5.0 (X11; Linux x86_64; rv:102.0) Gecko/20100101 Firefox/102.0', 'linux', '0.0.0', 'firefox', '102.0.0'",
        "'Mozilla/5.0 (X11; Linux 86_64) AppleWebKit/537.36 (KHTML, like Gecko) Safari/537.36', 'linux', '0.0.0', 'safari', '0.0.0'",
        ...
        "'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5845.110 Safari/537.36 Edg/116.0.1938.69', 'linux', '0.0.0', 'edge', '116.0.1938'",
    ...
    void parseUserAgent_WhenValidUserAgent_ShouldReturnDevice(
        ...
        var actualOsVersion = ua.osVersion().toString();
        var actualBrowserName = ua.browserName();
        var actualBrowserVersion = ua.browserVersion().toString();
